...
# transfer to tensor
train = MNIST('./data/1_Mnist', train=True, download=True, transform=transforms.ToTensor())

test = MNIST('./data/1_Mnist', train=False, download=True, transform=transforms.ToTensor())
